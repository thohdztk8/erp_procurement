  ...
  <SectionMain>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
      ...
      <CardBox class="lg:col-span-1 p-4">
        ...
        <ul class="space-y-2">
          <li v-for="o in orders" :key="o.order_id"
      ...
      <div class="lg:col-span-2 space-y-4">
        ...
        <div v-else class="space-y-6">
          ...
          <!-- List Báo giá -->
          <div v-for="q in quotations" :key="q.quotation_id"
            class="bg-white dark:bg-gray-800 border rounded-lg shadow-sm p-5 space-y-4">
            <div class="flex justify-between items-start border-b pb-3">
              ...
              <div class="text-right">
                ...
                <p class="text-lg font-black text-green-600 dark:text-green-400">{{ formatCurrency(q.total_amount) }}
                </p>
              </div>
            </div>
              ...
              <table class="w-full text-xs text-left border">
                ...
                <tbody>
                  <tr v-for="it in q.items" :key="it.quotation_item_id" class="border-b">
                    <td class="px-3 py-1.5 font-medium border-r">{{ it.order_item?.material?.material_name ||
                      it.order_item?.material_name_other }}</td>
                    ...
                    <td class="px-3 py-1.5 text-right font-semibold">{{ formatCurrency(it.qty_offered *
                      it.unit_price_offered) }}</td>
                  </tr>
                </tbody>
              </table>
            </div>
            ...
            <div class="flex justify-end pt-2 gap-3 items-center">
              ...
              <BaseButton v-if="q.is_selected" color="warning" label="Tạo Hợp đồng (IPO)" small
                @click="handleCreateIPO(q)" />

              <BaseButton v-else color="success" :icon="mdiBriefcaseCheck" label="Chọn thắng thầu" small
